              ...
              <div class="ms-3">
                ...
                <span v-for="(tipo, index) in menu.types" class="text-capitalize">
                  {{ index<menu.types.length - 1 ? tipo.name + ", " : tipo.name }} </span>
                    ...
                    <div v-else>
                      <span class="text-danger"><i class="fa-solid fa-circle text-danger"> </i> Ristorante chiuso  apre alle {{ menu.opening_hours.slice(0, 5) }},
                        preordina</span>
                    </div>
              </div>
            </div>
            <div class="row g-3 mt-3">
              <div v-for="(dish, i) in menu.dishes" class="col-12 col-lg-6 my-card" :key="i">
                <div class="inner-card d-flex">
                  <div class="img-box col-5"><img  v-if="dish.image" :src="`${store.imagBasePath}${dish.image}`" alt="">
                  <img v-else src="../../public/img/dd-slide.png" alt="">
                  </div>
